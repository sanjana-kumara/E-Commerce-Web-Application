...
if (isset($_SESSION["ad"])) {
    ...
    $rs = Database::search("SELECT * FROM `product` ORDER BY `product`.`id` ASC ");
    $num = $rs->num_rows;
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-8 mt-5 ms-5 d-flex justify-content-center">
                    <span class="col-5 fs-1 fw-bold">Stock Report</span>
                </div>
                    ...
                    <table class="table table-secondary table-hover mt-5 border border-3 border-black shadow-lg">
                        ...
                        <thead>
                            ...
                            <tr class="text-center">
                                ...
                                <th class="fs-3 fw-bold">Quantity</th>
                                <th class="fs-3 fw-bold">Unit Price</th>
                                <th class="fs-3 fw-bold">Date</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td class="fs-5 fw-bold"><?php echo $d["quantity"] ?></td>
                                    <td class="fs-5 fw-bold"><?php echo $d["price"] ?></td>
                                    <td class="fs-5 fw-bold"><?php echo $d["datetime_add"] ?></td>
