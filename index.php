                    ...
                    <div class="col-12 col-lg-6 d-none" id="signUpBox">
                        <div class="row g-2 ">
                            ...
                            <div class="col-11 col-lg-6 d-grid mt-3">
                                <button class="btn btn-primary fs-4" onclick="signUp();">Sign Up</button>
                            </div>

                            <div class="col-11 col-lg-5 d-grid mt-3">
                                <button class="btn btn-dark fs-4" onclick="changeView();">Already have an account? Sign In</button>
                            </div>
